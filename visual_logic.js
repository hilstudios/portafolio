...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        replaceMaterialEditableTexture, getObjectUUID, getObjectByName, getSceneAnimFrameRate,
        getSceneByAction,
    };
};
...
registerOnHover('Plane', false, function(event) {
...
click = 'ON';
videoCelular = loadVideo('https://raw.githack.com/hilstudios/vid/main/TestingCroma.mp4');
registerOnClick('Plane', false, false, [0,1,2], false, function(event) {
    if (click == 'ON') {
        replaceTexture('Material', 'screenClick.jpg', videoCelular, false, function() {
...
registerOnHover('Albert', false, function(event) {
    outline('Albert', 'ENABLE');
}, function(event) {
    outline('Albert', 'DISABLE');
});

operateAnimation('STOP', 'Albert', null, null, 'AUTO', 1, function() {}, false);

registerOnClick('Albert', false, false, [0,1,2], false, function(event) {
    if (animar == 'ON') {
        operateAnimation('PLAY', 'Albert', 0, 30, 'LoopOnce', 1, function() {
            animar = 'OFF';
        }, false);
    } else {
        operateAnimation('PAUSE', 'Albert', null, null, 'AUTO', 1, function() {}, false);
        operateAnimation('PLAY', 'Albert', 0, 30, 'LoopOnce', 1, function() {
            animar = 'ON';
        }, true);
    }
